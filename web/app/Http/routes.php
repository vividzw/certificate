...
Route::get('/depart/export', 'ProDepartmentController@export');
...
Route::get('/subject/export', 'SubjectController@export');
...
Route::get('/classteacher/export', 'ClassTeacherController@export');
